...
public static void main(String[] args) {
    ...
    LinkedList BankStaffAccountLL = new LinkedList();
    LinkedList CustomerAccountLL = new LinkedList();
    LinkedList BillLL = new LinkedList();
    Bank bank = new Bank();
...
public static void readStaff(Bank Bank, LinkedList BankStaffAccountLL) {
    try{
        ...
        while((line = bufferRead.readLine()) != null){
            ...
            if(tokenizer.countTokens() == 9){
                ...
                Bank.addNumberOfStaff();
                BankStaffAccountLL.addLast(temporaryStaff);
            }
        }
}   
...
public static void readAccount(Bank Bank, LinkedList CustomerAccountLL) {
    try{
        ...
        while((line = bufferRead.readLine()) != null){
            ...
            if(tokenizer.countTokens() == 15){
                ...
                Bank.addNumberOfAccount();
                CustomerAccountLL.addLast(temp);
            }
        }
...
public static void readBill(Bank Bank, LinkedList BillLL) {
    try{
...
public static void writeStaff(Bank Bank, LinkedList BankStaffAccountLL){
    ...
    try{
        ...
        LinkedList TemporaryStaffLL = new LinkedList();
        while(!BankStaffAccountLL.isEmpty()){
            BankStaff temp = (BankStaff) BankStaffAccountLL.removeFirst();
            TemporaryStaffLL.addLast(temp);
            PrintStaff.println(temp.WriteString());
        }
       while(!TemporaryStaffLL.isEmpty()){
            BankStaffAccountLL.addFirst(TemporaryStaffLL.removeLast());
       }
        PrintStaff.close();
}   
catch(Exception ex){}
...
public static void writeAccount(Bank Bank, LinkedList CustomerAccountLL){
    ...
    try{
        ...
        LinkedList TemporaryAccountLL = new LinkedList();
        while(!CustomerAccountLL.isEmpty()){
            Account temp = (Account) CustomerAccountLL.removeFirst();
            TemporaryAccountLL.addLast(temp);
            PrintAccount.println(temp.WriteString());
        }
       while(!TemporaryAccountLL.isEmpty()){
            CustomerAccountLL.addFirst(TemporaryAccountLL.removeLast());
       }
        PrintAccount.close();
}   
catch(Exception ex){}
...
public static void WriteBill(Bank Bank, LinkedList BillLL) {
    try{
        ...
        LinkedList TemporaryBillLL = new LinkedList();
        while(!BillLL.isEmpty()){
            Bill temp = (Bill) BillLL.removeFirst();
            TemporaryBillLL.addLast(temp);
            PrintBill.println(temp.WriteString());
        }
       while(!TemporaryBillLL.isEmpty()){
            BillLL.addFirst(TemporaryBillLL.removeLast());
       }
        PrintBill.close();
...
public static void RegisterUser(char UserRegisterType, LinkedList BankStaffAccountLL, LinkedList CustomerAccountLL, Bank bank){
    Scanner Input = new Scanner(System.in);
    ...
    if (UserRegisterType == 'S'){
     //enter basic user information
        ...
        BankStaffAccountLL.addLast(temp);
        ...
        CustomerAccountLL.addLast(newAccount);
        writeAccount(bank, CustomerAccountLL);
...
public static boolean LoginUser(char UserRegisterType, LinkedList BankStaffAccountLL, LinkedList CustomerAccountLL, Bank bank){
    
    Scanner In = new Scanner(System.in);
    Scanner Input = new Scanner(System.in);

    LinkedList tempAccountLL = new LinkedList();
    LinkedList tempStaffLL = new LinkedList();
    ...
    while (Chance != 0){
        ...
        if(UserRegisterType == 'S'){
            ...
            while(!tempStaffLL.isEmpty()){
                BankStaffAccountLL.addFirst(tempStaffLL.removeLast());
            }
        }
        ...
        while(!tempAccountLL.isEmpty()){
            CustomerAccountLL.addFirst(tempAccountLL.removeLast());
        }
    }
}
...
public static boolean IsAccountAlreadyExist(LinkedList BankStaffAccountLL, LinkedList CustomerAccountLL, String IC){
...
public static String GenerateUniqueID(int count, char Type){
    Random random = new Random();
    Set<Integer> uniquePositiveIntegers = new HashSet<>();
...
public static void UserMenu(String DateAndTime,LinkedList BillLL,LinkedList BankStaffAccountLL,LinkedList CustomerAccountLL, Bank bank, String CurrentUserID){
...
public static void AccountSettings(char Option,LinkedList CustomerAccountLL,LinkedList BankStaffAccountLL,BankStaff StaffAccount,Account Account, Bank bank , char UserType){
                ...
                while (chance != 0) {
                  ...
                  if(CurrentPassword.equals(StaffAccount.getStaffPassword())){
                    ...
                    if(AccountSettingsOption == 'X'){
                        ...
                        if(answer == 'Y'){
                            LinkedList tempAccount = new LinkedList();
                            while(!CustomerAccountLL.isEmpty()){
                                Account temp = (Account) CustomerAccountLL.removeFirst();
                                if(temp.getAccountID().equals(Account.getAccountID())){
                                    ...
                                    tempAccount.addLast(temp);
                                }
                            }
                            while(!tempAccount.isEmpty()){
                                CustomerAccountLL.addLast(tempAccount.removeFirst());
                            }
                            System.out.println("+------------------------------------------------+");
...
public static void AccountTransactionMenu(String DateAndTime,LinkedList BillLL,LinkedList CustomerAccountLL,Account Account, Bank bank, char UserType){
    Scanner input = new Scanner(System.in);
    Scanner InputUser = new Scanner(System.in);
    ...
    while (AccountTransactionOption != 'X') {
        ...
        if(AccountTransactionOption == 'D'){
            ...
            LinkedList temporaryLL = new LinkedList();
...
public static void AccountTransactionHistory(Account Account, LinkedList BillLL){
...
public static void StaffMenu(String currentTime,LinkedList BillLL, LinkedList BankStaffAccountLL, LinkedList CustomerAccountLL, Bank bank, String currentUserID){
    ...
    while(!tempAccountLL.isEmpty()){
        BankStaffAccountLL.addFirst(tempAccountLL.removeLast());
    }
...
public static void AdminUserMenu(String currentTime, LinkedList BillLL, LinkedList CustomerAccountLL, Bank bank, String currentUserID){
    ...
    LinkedList tempAccount = new LinkedList();
    LinkedList tempBill = new LinkedList();
    ...
    while (UserOption != 'X') {
        ...
        if (UserOption == 'D') {
            ...
            if(UserOption == 'D'){
                ...
                while(!tempAccount.isEmpty()){
                    Account temp = (Account) tempAccount.removeFirst();
                    CustomerAccountLL.addLast(temp);
                }
            }
...
public static void AdminTransactionMenu(String currentTime, LinkedList BillLL, LinkedList CustomerAccountLL, Bank bank, String currentUserID, LinkedList BankStaffAccountLL){
    Scanner input = new Scanner(System.in);
    Scanner inputStaff = new Scanner(System.in);
        ...
        if (TransactionOption == 'D') {
            ...
            if(TransactionOption == 'S'){
                ...
                while(!TempLL.isEmpty()){
                    Bill temp = (Bill) TempLL.removeFirst();
                    BillLL.addLast(temp);
                }
            ...
            LinkedList tempBill = new LinkedList();
            LinkedList TempBankStaffLL = new LinkedList();
            LinkedList tempCustomer = new LinkedList();
            ...
            while(!BankStaffAccountLL.isEmpty()){
                ...
                TempBankStaffLL.addLast(temp);
            }
            while(!TempBankStaffLL.isEmpty()){
                BankStaff temp = (BankStaff) TempBankStaffLL.removeFirst();
                BankStaffAccountLL.addLast(temp);
            }
            ...
            while(!BillLL.isEmpty()){
                ...
                if(temp.getApproved() == "PENDING"){
                    ...
                    numberOfBillsApproved++;
                        while(!CustomerAccountLL.isEmpty()){
                        Account CustTemp = (Account) CustomerAccountLL.removeFirst();
                        ...
                        tempCustomer.addLast(CustTemp);
                    }
                    while(!tempCustomer.isEmpty()){
                        Account CustTemp = (Account) tempCustomer.removeFirst();
                        CustomerAccountLL.addLast(CustTemp);
                    }
                }
                tempBill.addLast(temp);
            }
            while(!tempBill.isEmpty()){
                Bill temp = (Bill) tempBill.removeFirst();
                BillLL.addLast(temp);
            }
            WriteBill(bank, BillLL);
            writeAccount(bank, CustomerAccountLL);
...
public static void DisplayBill(char TransID, LinkedList BillLL){

    if(TransID == 'Z'){
        LinkedList TempBill = new LinkedList();
        while(!BillLL.isEmpty()){
            Bill temp = (Bill) BillLL.removeFirst();
            TempBill.addLast(BillLL);
            System.out.println("+------------------------------------------------+");
            System.out.println(temp.printData());
            System.out.println("+------------------------------------------------+");
        }
        while(!TempBill.isEmpty()){
            BillLL.addFirst(TempBill.removeLast());
        }
    }
    else if(TransID == 'D'){
